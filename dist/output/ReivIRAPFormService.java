...
@Component
public class ReivIRAPFormService implements FormService
{
    public static final String BEANID = "ReivIRAPFormService";
                            ...
                            FunctionalContext functionalContext)
    {
        if (event.getValue().equals(LovEvent.SCREENOPENED.getValue()) &&
            inParameters.get("SCREENID").equals("ReivIRAP"))
        {
            Data data = new Data();
            String xidlog = utilsService.xlogCreate("REIVC");
